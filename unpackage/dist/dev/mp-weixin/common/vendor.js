...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"前端小程序","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!******************************************************************!*\
  !*** C:/Users/86182/Documents/HBuilderProjects/前端小程序/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var b = "development" === "development",
  ...
  C = T({"address":["127.0.0.1","192.168.20.9"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/86182/Downloads/HBuilderX.4.76.2025082103/HBuilderX/plugins/unicloud/**/*.js"]}),
  O = T([{"provider":"aliyun","spaceName":"evaldemo","spaceId":"mp-380dc448-8fe0-4623-8e1d-971ca38d2715","clientSecret":"aDxsAQ5ppZelqLsFpbzZTg==","endpoint":"https://api.next.bspapp.com"}]) || [],
  x = true;
var N = "";
try {
...
/* 38 */
/*!**********************************************************************************!*\
  !*** C:/Users/86182/Documents/HBuilderProjects/前端小程序/pages.json?{"type":"stat"} ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 45 */
/*!********************************************************************************!*\
  !*** C:/Users/86182/Documents/HBuilderProjects/前端小程序/uni.promisify.adaptor.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.ageBands = void 0;
exports.convertOldQuestions = convertOldQuestions;
exports.getAgeBandByMonths = getAgeBandByMonths;
exports.pickQuestionsByAgeMonths = pickQuestionsByAgeMonths;
...
// 题目数据
exports.ageBands = ageBands;
var questions = [
// 1-3个月题目
// 视知觉(OSV)功能发育
{
  id: '1_3m-OSV-001',
  text: '视力为0.1,可见30公分内距离的物体,注视距离为1.5米',
  domain: '感知觉',
  subdomain: 'OSV',
  ageBandKey: '1_3m',
  type: 'check',
...
{
  id: '1_3m-OSH-001',
  text: '注意1000到3000赫兹(偏于听高频)的声音,(听阈值60-70DB)',
  domain: '感知觉',
  subdomain: 'OSH',
  ageBandKey: '1_3m',
  type: 'check',
...
// 本体运动知觉(ISP)功能发育
{
  ...
  id: '1_3m-ISP-008',
  text: '感受自己身体和重力的感觉(身体歪斜会拉回来，并可以维持平衡寻找支点)',
  domain: '感知觉',
  subdomain: 'ISP',
  ageBandKey: '1_3m',
  type: 'check',
...
// 前庭平衡知觉(ISV)功能发育
{
  ...
  id: '1_3m-ISV-002',
  text: '感受到自己身体顺应重力刺激的抗拒感觉(偏离身体重力中线时)出现不自主的保护性反射动作',
  domain: '感知觉',
  subdomain: 'ISV',
  ageBandKey: '1_3m',
  type: 'check',
...
{
  id: '1_3m-GM-001',
  text: '仰卧摆位时，可情境诱导自主双手、双脚中线不停乱踢3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '1_3m',
  type: 'check',
  ...
  id: '1_3m-GM-002',
  text: '扶持双肩坐立摆位下，可情境诱导自主头颈中线直立(不垂头)2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '1_3m',
  type: 'check',
...
{
  id: '1_3m-MLEY-001',
  text: '哭声，对大噪音有反应（如眨眼、停止一个动作、眼睛到处移动或是一个惊惧的反应）',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '1_3m',
  type: 'check',
...
// 本体运动知觉(ISP)功能发育
{
  ...
  id: '3_6m-ISP-003',
  text: '手、嘴和眼睛相互配合探索自己的身体、玩具、周围环境',
  domain: '感知觉',
  subdomain: 'ISP',
  ageBandKey: '3_6m',
  type: 'check',
...
// 前庭平衡知觉(ISV)功能发育
{
  ...
  id: '3_6m-ISV-002',
  text: '趴着时，会一手撑上半身重量，另一手伸向玩具，玩玩具',
  domain: '感知觉',
  subdomain: 'ISV',
  ageBandKey: '3_6m',
  type: 'check',
...
{
  id: '3_6m-GM-001',
  text: '俯趴摆位下，可情境诱导自主从俯趴姿势至仰躺姿势翻身1下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '3_6m',
  type: 'check',
  ...
  id: '3_6m-GM-002',
  text: '仰卧摆位下，可情境诱导自主从仰躺姿势至俯趴姿势翻身1下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '3_6m',
  type: 'check',
  ...
  id: '3_6m-GM-003',
  text: '俯趴摆位下，可情境诱导双手肘协同支撑地面2秒观看前方喜好物品或视频的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '3_6m',
  type: 'check',
  ...
  id: '3_6m-GM-004',
  text: '腹部及下半身俯趴楔形垫摆位下，可情境诱导双上肢协同支撑地面2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '3_6m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 情绪与自我(SIS)
{
  ...
  id: '3_6m-SIS-005',
  text: '痛苦的情绪会发展出，有害怕，厌恶，愤怒，悲伤，恐惧',
  domain: '社会互动',
  subdomain: 'SIS',
  ageBandKey: '3_6m',
  type: 'check',
...
// 认知(M)功能发育 - 记忆(MR) - 非动作认知(MRN)
{
  ...
  id: '3_6m-MRN-003',
  text: '能觉察到玩具被别人拿走(而4-5个月时不能觉察少什么)',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '3_6m',
  type: 'check',
...
{
  id: '3_6m-MCN-001',
  text: '对物体开始有完整的概念，当他看到一只手从沙发后伸出来时，就知道沙发后有人',
  domain: '认知',
  subdomain: 'MCN',
  ageBandKey: '3_6m',
  type: 'check',
...
// 口腔动作(OM)功能发育
{
  ...
  id: '3_6m-OM-005',
  text: '口腔动作仍是反射动作—流口水、牛奶溢出、哽呛动作不协调',
  domain: '口腔动作',
  subdomain: 'OM',
  ageBandKey: '3_6m',
  type: 'check',
...
// 语言(ML)功能发育 - 口语表达(说)(MLEY)
{
  ...
  id: '3_6m-MLEY-003',
  text: '进入呀呀学语阶段，能将辅音和元音结合连续发出（如辅音b和元音a结合连续发出形成bɑ-bɑ-bɑ，mɑ-mɑ-mɑ）类似爸、妈的单音节语音',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '3_6m',
  type: 'check',
...
{
  id: '6_9m-GM-001',
  text: '盘坐姿势摆位下，可情境诱导双上肢协同支撑地面2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-002',
  text: '跪坐姿势摆位下，可情境诱导双上肢协同支撑地面2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-003',
  text: '可情境诱导独立维持中线平面椅具(无靠背)坐立姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-004',
  text: '下半身俯趴楔形垫及双上肢支撑地面摆位下，可情境诱导双上肢交替玩弄物品3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-005',
  text: '双手部被动扶持摆位下，可情境诱导维持中线站立姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-006',
  text: '双手部被动扶持摆位下，可情境诱导维持中线高跪姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-007',
  text: '双手部被动扶持摆位下，可情境诱导维持中线向前跪走3步的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-008',
  text: '俯趴地面摆位下，可情境诱导双上肢交替支撑地面并向后坐立起1下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-009',
  text: '可情境诱导独立维持中线跪坐姿(双手无保护性支撑地面)2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-010',
  text: '俯趴摆位下，可情境诱导维持中线四点支撑爬姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-011',
  text: '独立跪坐姿摆位下，可情境诱导双上肢交替玩弄前方物品3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
  ...
  id: '6_9m-GM-012',
  text: '双手保护性扶持抓握物品摆位下，可情境诱导中线高跪姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '6_9m',
  type: 'check',
...
// 触知觉(OST)功能发育
{
  ...
  id: '9_12m-OST-002',
  text: '触觉和其他感觉联系在一起使用，通过看、听、摸顺利的完成任务',
  domain: '感知觉',
  subdomain: 'OST',
  ageBandKey: '9_12m',
  type: 'check',
...
// 前庭平衡知觉(ISV)功能发育
{
  ...
  id: '9_12m-ISV-005',
  text: '可跨步行走姿态(用双脚来支撑与维持平衡身体)(12个月)',
  domain: '感知觉',
  subdomain: 'ISV',
  ageBandKey: '9_12m',
  type: 'check',
...
// 躯肢体粗大动作(GM)功能发育
{
  ...
  id: '9_12m-GM-002',
  text: '双手自主扶持高位固定物品摆位下，可情境诱导维持中线高跪姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '9_12m',
  type: 'check',
...
{
  id: '9_12m-SIP-001',
  text: '会跟着别人的动作，以单纯会的动作或简单的声音做反应',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '9_12m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 情绪与自我(SIS)
{
  ...
  id: '9_12m-SIS-006',
  text: '移情出现:能对他人的情绪有所认识而共鸣或响应(如：安慰他人)',
  domain: '社会互动',
  subdomain: 'SIS',
  ageBandKey: '9_12m',
  type: 'check',
...
// 认知(M)功能发育 - 注意(MA) - 动作认知(MAY)
{
  ...
  id: '9_12m-MAY-002',
  text: '在听到一段音乐之后能模仿一些事，包括模仿动物的叫声',
  domain: '认知',
  subdomain: 'MAY',
  ageBandKey: '9_12m',
  type: 'check',
...
// 认知(M)功能发育 - 推理(MI) - 非动作认知(MIN)
{
  ...
  id: '9_12m-MIN-002',
  text: '开始建立时间、空间和因果关系(如：看到倒水盆里就知道等待洗澡)',
  domain: '认知',
  subdomain: 'MIN',
  ageBandKey: '9_12m',
  type: 'check',
  ...
  id: '9_12m-MIN-003',
  text: '可以用类推来解决问题(即取得来自一个问题的策略然后把它应用于其他相关的问题)',
  domain: '认知',
  subdomain: 'MIN',
  ageBandKey: '9_12m',
  type: 'check',
...
// 口腔动作(OM)功能发育
{
  ...
  id: '9_12m-OM-006',
  text: '喝水有进步，因下颌的稳定性仍不够，要么就张口很大要喝水，要么就是口腔开合困难不好喝水(喝水依然漏水或咬杯子)',
  domain: '口腔动作',
  subdomain: 'OM',
  ageBandKey: '9_12m',
  type: 'check',
...
{
  id: '12_18m-GM-001',
  text: '跪坐姿摆位下，可情境诱导独立维持中线高跪姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '12_18m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 与人互动(SIP)
{
  ...
  id: '12_18m-SIP-006',
  text: '能辨别父母脸上认可或不认可的表情(如：父母皱眉头表示不行)',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '12_18m',
  type: 'check',
...
{
  id: '12_18m-MRN-001',
  text: '能记住日常接触的动物、人、玩具的名称，包括亲人的名字',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '12_18m',
  type: 'check',
  ...
  id: '12_18m-MRN-002',
  text: '能记住动画片中的部分内容(记得最清楚的是人物的名字)',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '12_18m',
  type: 'check',
...
{
  id: '12_18m-MCN-001',
  text: '能听懂近50个常用词(如：车、船、房子、花、鸟、树等)',
  domain: '认知',
  subdomain: 'MCN',
  ageBandKey: '12_18m',
  type: 'check',
...
{
  id: '12_18m-MCY-001',
  text: '认识并正确指认经常接触的动物、玩具,以及自己的五官和四肢',
  domain: '认知',
  subdomain: 'MCY',
  ageBandKey: '12_18m',
  type: 'check',
...
// 口腔动作(OM)功能发育
{
  ...
  id: '12_18m-OM-007',
  text: '可用汤匙或手吃的津津有味，成熟的咀嚼动作可软硬都吃',
  domain: '口腔动作',
  subdomain: 'OM',
  ageBandKey: '12_18m',
  type: 'check',
...
// 语言(ML)功能发育 - 口语表达(说)(MLEY)
{
  ...
  id: '12_18m-MLEY-002',
  text: '开始说出有意义的单词,多用同一迭词在不同的情境表示几种不同的意思',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '12_18m',
  type: 'check',
...
{
  id: '18_24m-GM-001',
  text: '独立高跪姿摆位下，可情境诱导自主维持中线向前跪走3步的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '18_24m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 与人互动(SIP)
{
  ...
  id: '18_24m-SIP-017',
  text: '在探索环境时，会用口语或其他方式(如：拉大人)寻求大人协助',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '18_24m',
  type: 'check',
...
// 认知(M)功能发育 - 注意(MA) - 非动作认知(MAN)
{
  ...
  id: '18_24m-MAN-002',
  text: '能发现并注意到身边的新物品，对周围事物兴趣进一步增强',
  domain: '认知',
  subdomain: 'MAN',
  ageBandKey: '18_24m',
  type: 'check',
...
// 认知(M)功能发育 - 记忆(MR) - 非动作认知(MRN)
{
  ...
  id: '18_24m-MRN-003',
  text: '看到熟悉的图片(如：小鸭子、小兔子、苹果等能叫出名字)',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '18_24m',
  type: 'check',
...
{
  id: '18_24m-MCN-001',
  text: '认识日常吃的食物、所用的餐具、玩具以及常用的交通工具',
  domain: '认知',
  subdomain: 'MCN',
  ageBandKey: '18_24m',
  type: 'check',
...
// 认知(M)功能发育 - 概念(MC) - 动作认知(MCY)
{
  ...
  id: '18_24m-MCY-002',
  text: '能用副词"现在""一点儿""特别"来更准确的表达自己的意思',
  domain: '认知',
  subdomain: 'MCY',
  ageBandKey: '18_24m',
  type: 'check',
...
// 认知(M)功能发育 - 推理(MI) - 非动作认知(MIN)
{
  ...
  id: '18_24m-MIN-003',
  text: '能从环境线索来推论一件事(如:看到妈妈拿起包时，就知道妈妈要出去了)',
  domain: '认知',
  subdomain: 'MIN',
  ageBandKey: '18_24m',
  type: 'check',
...
{
  id: '18_24m-MLEY-001',
  text: '开始出现了由双词或三词组合在一起的语句(即：电报句)(18~24个月)',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '18_24m',
  type: 'check',
...
{
  id: '24_30m-ISV-001',
  text: '灵活原地双脚跳(利用21个月时出现的常态原地双脚跳姿态)',
  domain: '感知觉',
  subdomain: 'ISV',
  ageBandKey: '24_30m',
  type: 'check',
  ...
  id: '24_30m-ISV-002',
  text: '灵活沿直线跪走(利用23个月时出现的常态沿直线跪走姿态)',
  domain: '感知觉',
  subdomain: 'ISV',
  ageBandKey: '24_30m',
  type: 'check',
...
{
  id: '24_30m-GM-001',
  text: '双手被动扶持及高跪姿摆位下，可任务诱导(镜像模仿)双下肢交替半跪3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '24_30m',
  type: 'check',
  ...
  id: '24_30m-GM-002',
  text: '各单手被动扶持及高跪姿摆位下，可任务诱导(镜像模仿)双下肢交替半跪3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '24_30m',
  type: 'check',
  ...
  id: '24_30m-GM-003',
  text: '双手携持物品及高跪姿摆位下，可任务诱导(镜像模仿)独立向前跪走3步的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '24_30m',
  type: 'check',
  ...
  id: '24_30m-GM-004',
  text: '双手携持物品及高跪姿摆位下，可任务诱导(镜像模仿)独立向后跪走3步的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '24_30m',
  type: 'check',
...
{
  id: '24_30m-MAN-001',
  text: '能注意到内心思想与外部事件的差异(知道别人不见了是去别的地方，而不是消失)',
  domain: '认知',
  subdomain: 'MAN',
  ageBandKey: '24_30m',
  type: 'check',
...
// 认知(M)功能发育 - 概念(MC) - 动作认知(MCY)
{
  ...
  id: '24_30m-MCY-002',
  text: '知道大人和小孩的区别，也知道小盒子可以放在大盒子里',
  domain: '认知',
  subdomain: 'MCY',
  ageBandKey: '24_30m',
  type: 'check',
...
{
  id: '24_30m-MLUY-001',
  text: '了解"上""下""里面""旁边"等位置观念(25~27个月)',
  domain: '语言',
  subdomain: 'MLUY',
  ageBandKey: '24_30m',
  type: 'check',
...
{
  id: '24_30m-MLEY-001',
  text: '发展出完整句(简单句→复杂句→复合句)(25~30个月)',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '24_30m',
  type: 'check',
...
{
  id: '30_36m-GM-001',
  text: '简单任务指令要求下，可自主模仿独立交替半跪3下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '30_36m',
  type: 'check',
  ...
  id: '30_36m-GM-002',
  text: '任务指令要求及高跪姿摆位下，可自主模仿维持各单脚半跪姿及诱导搭配覆诵发音数数(1~10)的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '30_36m',
  type: 'check',
  ...
  id: '30_36m-GM-003',
  text: '任务指令要求下，可自主完成独立交替半跪(1~10下)活动及同时搭配自主发音数数的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '30_36m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 与人互动(SIP)
{
  ...
  id: '30_36m-SIP-006',
  text: '遵守简单有关礼貌方面的规则(建立简单学习常规与社交能力)',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '30_36m',
  type: 'check',
...
{
  id: '30_36m-MAY-001',
  text: '能注意周围环境中的变化并和认识过程结合起来(有意义的注意开始出现)',
  domain: '认知',
  subdomain: 'MAY',
  ageBandKey: '30_36m',
  type: 'check',
...
// 认知(M)功能发育 - 概念(MC) - 动作认知(MCY)
{
  ...
  id: '30_36m-MCY-002',
  text: '有了多项选择能力，比如：妈妈说"把红色的皮球给我"(在之前他只知道拿红色的球却不一定是皮的)',
  domain: '认知',
  subdomain: 'MCY',
  ageBandKey: '30_36m',
  type: 'check',
...
{
  id: '30_36m-MIY-001',
  text: '开始有了自我感受，但这种感受非常直接(如：妈妈骂了他，就会认为妈妈不喜欢他)',
  domain: '认知',
  subdomain: 'MIY',
  ageBandKey: '30_36m',
  type: 'check',
  ...
  id: '30_36m-MIY-006',
  text: '能依眼睛看到的资料为基础，猜出物品的名称(如：告诉孩子动物的特征，让其猜出是什么动物)',
  domain: '认知',
  subdomain: 'MIY',
  ageBandKey: '30_36m',
  type: 'check',
...
{
  id: '30_36m-MLUY-001',
  text: '能听懂有关位置、所有权及数量的问话(31~33个月)',
  domain: '语言',
  subdomain: 'MLUY',
  ageBandKey: '30_36m',
  type: 'check',
...
{
  id: '30_36m-MLUN-001',
  text: '能说出100张(或多张)左右图片名称(31~33个月)',
  domain: '语言',
  subdomain: 'MLUN',
  ageBandKey: '30_36m',
  type: 'check',
...
{
  id: '36_48m-GM-001',
  text: '任务指令要求下，可自主独立完成正确交替半跪抬脚数量概念(1~10下)的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-002',
  text: '半跪姿摆位下，可自主独立完成各单脚半跪姿站立起1下的活动与姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-003',
  text: '高跪姿摆位下，可自主独立完成正确交替半跪及对侧上肢抬手与数数(1~10下)的多样性活动与姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-004',
  text: '任务指令要求下，可自主双手扶地维持中线蹲姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-005',
  text: '任务指令要求下，可自主独立维持中线蹲姿2秒的姿势发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-006',
  text: '任务指令要求下，可自主独立完成连续动态全蹲站2下的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-007',
  text: '任务指令要求下，可自主独立完成扶地向前蹲走3步的活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-008',
  text: '任务指令要求下，可自主独立完成向前蹲走3步活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
  ...
  id: '36_48m-GM-009',
  text: '任务指令要求下，可自主独立完成向后蹲走3步活动发育',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '36_48m',
  type: 'check',
...
// 社会性(SI)互动功能发育 - 与人互动(SIP)
{
  ...
  id: '36_48m-SIP-011',
  text: '当要求某些物品时，会以比较适当的行为代替哭、闹的方式',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '36_48m',
  type: 'check',
...
// 认知(M)功能发育 - 注意(MA) - 非动作认知(MAN)
{
  ...
  id: '36_48m-MAN-005',
  text: '注意力集中，能在注意转移之前专心玩游戏或者连续看20分钟电视',
  domain: '认知',
  subdomain: 'MAN',
  ageBandKey: '36_48m',
  type: 'check',
...
// 认知(M)功能发育 - 记忆(MR) - 非动作认知(MRN)
{
  ...
  id: '36_48m-MRN-002',
  text: '能记得并重复包含形容词的四个字的句子(如：你好漂亮)',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '36_48m',
  type: 'check',
...
// 认知(M)功能发育 - 概念(MC) - 非动作认知(MCN)
{
  ...
  id: '36_48m-MCN-003',
  text: '数量概念形成的最佳时期(这时宝宝已经掌握了10以内数的概念)',
  domain: '认知',
  subdomain: 'MCN',
  ageBandKey: '36_48m',
  type: 'check',
...
{
  id: '60_72m-GM-001',
  text: '双手协同携物及单脚站立姿摆位下，可自主独立完成正确各单脚维持中线站立5秒并慢速数数1~5下的姿势控制',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-GM-002',
  text: '四点爬姿摆位下，可自主独立完成正确对侧交替抬脚、抬手及维持中线姿势控制10秒并能倒数第几回及正数数1~10秒活动与姿势控制(例如:10，1~10；9，1~10；~1，1~10)',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-GM-003',
  text: '各单脚站立摆位下，可自主独立完成正确单脚原地连续跳5下，及期间各维持5秒单脚站立姿势并能配合正数第几回及正数数1~5秒活动与姿势控制(例如:1，1~5；2，1~5；~5，1~5)',
  domain: '粗大动作',
  subdomain: 'GM',
  ageBandKey: '60_72m',
  type: 'check',
...
{
  id: '60_72m-MAN-001',
  text: '观察逐渐转变为一个相互独立的，有目的、有组织的过程(并开始逐步形成有方向的，自觉的观察力)',
  domain: '认知',
  subdomain: 'MAN',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-MAN-002',
  text: '有意识注意明显增强，能按活动的目的和成人的要求进行',
  domain: '认知',
  subdomain: 'MAN',
  ageBandKey: '60_72m',
  type: 'check',
...
{
  id: '60_72m-MRN-001',
  text: '已有意识记忆，能接受家长和老师的要求，进行有目的的记忆',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-MRN-002',
  text: '10个熟悉物品中能够记住6-7个，不熟悉物品中也能记住4-5个',
  domain: '认知',
  subdomain: 'MRN',
  ageBandKey: '60_72m',
  type: 'check',
...
// 认知(M)功能发育 - 推理(MI) - 非动作认知(MIN)
{
  ...
  id: '60_72m-MIN-006',
  text: '能解决有逻辑推理问题(如：根据三个图形的关系找出第四个图形)',
  domain: '认知',
  subdomain: 'MIN',
  ageBandKey: '60_72m',
  type: 'check',
...
// 语言(ML)功能发育 - 口语表达(说)(MLEY)
{
  ...
  id: '60_72m-MLEY-002',
  text: '会说有因果转折、条件假设等关系的连词的句子（如"为了""结果""要不然"…）',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-MLEY-004',
  text: '能很流利地表达复杂的句型，会讲较复杂的故事(67~72个月)',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '60_72m',
  type: 'check',
  ...
  id: '60_72m-MLEY-005',
  text: '会说量词，但还不能很正确地遵从"数词+量词+名词"，(如：一辆自行车)',
  domain: '语言',
  subdomain: 'MLEY',
  ageBandKey: '60_72m',
  type: 'check',
...
{
  id: '60_72m-SIP-001',
  text: '在大人协助下，能和同伴玩简单的规则性游戏(如：五子棋)',
  domain: '社会互动',
  subdomain: 'SIP',
  ageBandKey: '60_72m',
  type: 'check',
...
{
  id: '60_72m-SIE-001',
  text: '在大人监督下，在自己住家附近玩，而不会乱跑到马路上去',
  domain: '社会互动',
  subdomain: 'SIE',
  ageBandKey: '60_72m',
  type: 'check',
...
function getAgeBandByMonths(ageMonths) {
  return ageBands.find(function (band) {
    return ageMonths >= band.ageMinMonths && ageMonths <= band.ageMaxMonths;
  }) || null;
}

// 工具函数：根据月龄和模式获取题目
function pickQuestionsByAgeMonths(ageMonths) {
  var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'band';
  console.log("=== \u83B7\u53D6\u9898\u76EE ===");
  console.log("\u6708\u9F84: ".concat(ageMonths, ", \u6A21\u5F0F: ").concat(mode));
  var targetAgeBands = [];
  if (mode === 'band') {
    // 精准模式：仅当前年龄段
    var currentBand = getAgeBandByMonths(ageMonths);
    if (currentBand) {
      targetAgeBands = [currentBand];
      console.log("\u7CBE\u51C6\u6A21\u5F0F - \u5F53\u524D\u5E74\u9F84\u6BB5: ".concat(currentBand.label));
    }
  } else if (mode === 'cumulative') {
    // 累进模式：<= 当前月龄的所有段
    targetAgeBands = ageBands.filter(function (band) {
      return ageMonths >= band.ageMinMonths;
    });
    console.log("\u7D2F\u8FDB\u6A21\u5F0F - \u5E74\u9F84\u6BB5: ".concat(targetAgeBands.map(function (b) {
      return b.label;
    }).join(', ')));
  }
  ...
  // 获取目标年龄段的题目
  var targetKeys = targetAgeBands.map(function (band) {
    return band.key;
  });
  var filteredQuestions = questions.filter(function (q) {
    return targetKeys.includes(q.ageBandKey);
  });
  console.log("\u627E\u5230\u9898\u76EE\u6570\u91CF: ".concat(filteredQuestions.length));
  ...
  console.log("\u5206\u7EC4\u7ED3\u679C:", Object.keys(groupedQuestions).map(function (domain) {
    return "".concat(domain, ": ").concat(groupedQuestions[domain].length, "\u9898");
  }).join(', '));
  return groupedQuestions;
}

// 兼容旧题库的转换函数
function convertOldQuestions(oldQuestions) {
  return oldQuestions.map(function (q) {
    if (q.options && Array.isArray(q.options)) {
      // 旧格式：有options数组
      var hasDeveloped = q.options.some(function (opt) {
        return opt.value === '已具备' && opt.selected;
      });
